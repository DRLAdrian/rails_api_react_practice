...
class AirlinesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create airline" do
    assert_difference("Airline.count") do
      post airlines_url, params: { airline: { image_url: @airline.image_url, name: @airline.name, slug: @airline.slug } }
    end
  ...
  test "should update airline" do
    patch airline_url(@airline), params: { airline: { image_url: @airline.image_url, name: @airline.name, slug: @airline.slug } }
